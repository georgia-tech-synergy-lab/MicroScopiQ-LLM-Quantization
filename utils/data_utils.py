...
token_auth_kwargs_data = {}
token_auth_kwargs_data["use_auth_token"] = HF_TOKEN
...
def get_pile(nsamples, seed, seqlen, model):
    ...
    tokenizer = AutoTokenizer.from_pretrained(model, use_fast=False, **token_auth_kwargs_data)
